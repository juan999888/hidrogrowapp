...
<head>
  ...
  <title>dashboard hidroponista</title>
...
<body>
  ...
  <div id="div-nav">
    ...
    <a class="nav-dos" href="PHP/cerrar_sesion.php">LOGOUT</a>
       ...
       <article class="caja-blur" style="height: 700px;">
        <hr><br>
        <div>
        <div class="menu">
            <div class="menu-item">
                ...
                <div class="submenu">
                    <a href="PHP/crear cultivo (hidroponista).php" class="submenu-link">Registrar</a>
                    <a href="PHP/editar cultivo (hidroponista).php" class="submenu-link">Editar</a>
                    <a href="PHP/consultar_cultivo (hidroponista).php" class="submenu-link">Consultar</a>
                    <a href="PHP/todos_los cultivos_hidro.php" class="submenu-link">Consultar todos los cultivos</a>
                    <a href="importar_cultivos_ecxel hidro.html" class="submenu-link">Importar datos de cultivos desde excel</a>
                    <a href="PHP/registrar_especies_hidro.php" class="submenu-link">Registrar especie para los cultivos</a>
            ...
            <div class="menu-item">
              ...
              <div class="submenu">
                  <a href="Crear nota_(hidro).html" class="submenu-link">Registrar</a>
                  <a href="PHP/consultar notass(hidro).php" class="submenu-link">Consultar</a>
                  <a href="PHP/Eliminar nota_(hidro).php" class="submenu-link">Eliminar</a>
                  <a href="PHP/Mirar todas las notas_(hidro).php" class="submenu-link">Consultar todas las notas</a>
